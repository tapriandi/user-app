...
export default function FormAddUser({ title, titleButton }) {
  ...
  const createNewUser = async (user) => {
    try {
      ...
      setLoading(false);
      setMessageAddUser({ msg: "Add New User, Gagal!", color: "text-red-500" });
    }
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <span className={`${messageAddUser.color} pb-3 pt-1 text-[9px]`}>
          {messageAddUser.msg}
        </span>
      </form>
    </div>
